...
<html>
    ...
    <form action="<?= HOST ?>oplossing-file-upload-login-process.php" method="POST">
        <ul>
            <li>
    ...
    <a href="<?= HOST ?>oplossing-file-upload-registratie-form.php">Nog geen account? Registreer je op deze pagina.</a>
